...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler("script_debug.log"),  # Log to file
            ...
            try:
                ...
                try:
                    ...
                    def get_timestamp_column(cursor, table_name):
                        ...
                        return result[0] if result else None  # Return column name if found, else None
                    ...
                    latest_timestamp = latest_timestamp.strftime('%Y-%m-%d %H:%M:%S') if latest_timestamp else "1900-01-01 00:00:00" #"2023-01-01 00:00:00" #
                ...
                if type_id == 1:
                    ...
                    try:
                        ...
                        cursor.execute(f"SELECT * FROM {target_table} WHERE 1=0") # This fetches just the column names without data
                        
                        # Get column names from the cursor description
                        columns = [desc[0] for desc in cursor.description]
                        
                        # Validate that there are exactly 2 columns and the first is "Timestamp"
                    ...
                    try:
                        ...
                        response.raise_for_status()
                        api_data = response.json()
                        # Extract valid records newer than the latest timestamp
                ...
                if processed_data:
                    ...
                    try:
                        ...
                        # Prepare data based on retrieved column names
                        # data_to_insert = [
                        ...
                        safe_cte_query = cte_query.replace("'", "''")  # Escape single quotes
...
def run_scheduled_task():
    logging.info("⏱️ Running scheduled forex data fetch...")
