            ...
            for ticker in tickers:
                try:
                    ...
                    for record in api_data.get("feed", []):
                        ...
                        ticker_info = record.get("ticker_sentiment", [{}])[0]
            ...
            for record in processed_data:
                ...
                if not cursor.fetchone():
                    try:
                        ...
                        logging.error(f"Error inserting record at {published_at}: {e}")


            conn.commit()
            logging.info("All data successfully inserted into Market News & Sentiment.")
